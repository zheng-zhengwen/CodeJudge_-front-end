...
import type { BaseResponse_UserQuestionVO_ } from "../models/BaseResponse_UserQuestionVO_";
...
export class UserControllerService {
  ...
  /**
   * getLoginUserQuestion
   * @returns BaseResponse_UserQuestionVO_ OK
   * @throws ApiError
   */
  public static getLoginUserQuestionUsingGet(): CancelablePromise<BaseResponse_UserQuestionVO_> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/user/get/userquestion",
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
        404: `Not Found`,
  ...
  /**
   * getLoginUserQuestionByQuestionId
   * @param questionId questionId
   * @returns BaseResponse_UserQuestionVO_ OK
   * @throws ApiError
   */
  public static getLoginUserQuestionByQuestionIdUsingGet(
    questionId: number
  ): CancelablePromise<BaseResponse_UserQuestionVO_> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/user/get/userquestion/{questionId}",
      path: {
